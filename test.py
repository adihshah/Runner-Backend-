...
class TestRoutes(unittest.TestCase):
    ...
    def test_create_class(self):
        res = requests.post(LOCAL_URL + '/api/classes/',
                            data=json.dumps(CLASSBODY))
        cls = res.json()['data']
        assert res.json()['success']
    ...
    def test_add_user_invalid_class(self):
        ...
        res = requests.post(
            LOCAL_URL + '/api/class/1000/add/', data=json.dumps(body))
        assert not res.json()['success']
    ...
    def test_cls_id_increments(self):
        ...
        res2 = requests.post(LOCAL_URL + '/api/classes/',
                             data=json.dumps(CLASSBODY))
